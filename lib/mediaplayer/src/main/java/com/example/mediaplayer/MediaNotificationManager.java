...
public class MediaNotificationManager extends BroadcastReceiver {
    ...
    public MediaNotificationManager(MediaPlayerService mediaPlayerService) {
        ...
        this.m_vPlayAction = new Notification.Action.Builder(Icon.createWithResource(m_vService.getBaseContext(), android.R.drawable.ic_media_play),"Play", playActionIntent).build();
        this.m_vPauseAction = new Notification.Action.Builder(Icon.createWithResource(m_vService.getBaseContext(), android.R.drawable.ic_media_pause),"Pause", pauseActionIntent).build();
        this.m_vPlayPrevAction = new Notification.Action.Builder(Icon.createWithResource(m_vService.getBaseContext(), android.R.drawable.ic_media_previous),"Play Previous", playPrevActionIntent).build();
        this.m_vPlayNextAction = new Notification.Action.Builder(Icon.createWithResource(m_vService.getBaseContext(), android.R.drawable.ic_media_next),"Play Next", playNextActionIntent).build();
        ...
        this.m_vService.registerReceiver(this, intentFilter);
